...
a token is to identify you as being authorized, and how much you are authorized to see into the API

- [x] What steps can you take in your web apps to keep your data secure?
Don't use a default token, make sure any private information is encrypted end to end. 

- [x] Describe how web servers work.
A client asks for information through a request. could be a get, post, put, delete, or other request. once the server receives this request it then processes the request and returns appropriate data for the authenticated or unauthenticated user of the system. that return then goes back to the client where it is displayed in the web browser. 
